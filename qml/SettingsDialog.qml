...
Popup {
    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            Text { Layout.fillWidth: true; text: "Andiya 0.1.4  |  Appearance and playback"; color: Theme.textMuted; font.pixelSize: Theme.fontScale * 9; horizontalAlignment: Text.AlignHCenter }
